...
struct ReturnTickerSamedaywithOutAndRTNText: View {
...
struct ReturnTickerSamedaywithOutAndRTNText_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            Color.gray.ignoresSafeArea()
            ReturnTickerSamedaywithOutAndRTNText(ticket: TicketRecord(
                origin: "Leeds (LDS)",
