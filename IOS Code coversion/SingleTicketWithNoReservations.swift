...
struct SingleTicketWithNoReservations: View {
...
struct SingleTicketWithNoReservations_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            Color.gray.ignoresSafeArea()
            SingleTicketWithNoReservations(ticket: TicketRecord(
                origin: "Leeds (LDS)",
