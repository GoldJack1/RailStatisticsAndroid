...
struct ReturnTicketReturn: View {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: -5) {
                        ...
                        // Destination text on its own line (swapped)
                        Text(ticket.origin)
                            .font(.geologicaCRSV(size: 15, crsv: 1.0, wght: 400))
                            .foregroundColor(mainTextColor)
                        // To and Until date (swapped)
...
struct ReturnTicketReturn_Previews: PreviewProvider {
    static var previews: some View {
        ZStack {
            Color.gray.ignoresSafeArea()
            ReturnTicketReturn(ticket: TicketRecord(
                origin: "Leeds (LDS)",
